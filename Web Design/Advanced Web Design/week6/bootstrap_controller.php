...
if ($page == 'StartPage') 
{
    ...
    case 'SignIn':
        ...
        include ('bootstrap_view_mainpage.php');  // MainPage
...
else if ($page == 'MainPage') 
{
    ...
    case 'SearchQuestions':
        ...
        include ('bootstrap_view_mainpage_searchquestions.php');  // view_mainpage_searchquestions.php, not view_mainpage.php
        break;
    defalut:
